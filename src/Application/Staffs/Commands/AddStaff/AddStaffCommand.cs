...
namespace Application.Staffs.Commands.AddStaff;

public record AddStaffCommand : IRequest<StaffDto>
{
...
public class AddStaffCommandHandler : IRequestHandler<AddStaffCommand, StaffDto>
{
    ...
    public AddStaffCommandHandler(IApplicationDbContext context, IMapper mapper)
    {
        _context = context;
        _mapper = mapper;
    }
