...
public class CustomApiFactory : WebApplicationFactory<IApiMarker>
{
    ...
    {        
        builder.ConfigureServices((builderContext, services) =>
        {
            ...
            {
                options.UseNpgsql("Server=localhost;Port=5432;Database=mytestdb;User ID=profiletester;Password=supasupasecured;Include Error Detail=true", optionsBuilder => optionsBuilder.UseNodaTime());
            });
        });
    }
