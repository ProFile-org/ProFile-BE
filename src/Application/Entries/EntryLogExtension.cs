...
public static partial class EntryLogExtension
{
    ...
    public static partial void LogDownLoadFile(this ILogger logger, string userId, string fileId);
    
    [LoggerMessage(Level = LogLevel.Information, Message = EntryLogMessages.MoveEntryToBin, EventId = Common.Logging.EventId.Update)]
    public static partial void LogMoveEntryToBin(this ILogger logger, string userId, string entryId);
    
    [LoggerMessage(Level = LogLevel.Information, Message = EntryLogMessages.ShareEntry, EventId = EventId.OtherRequestRelated)]
    public static partial void LogShareEntry(this ILogger logger, string userId, string entryId, string sharedUserId);
    ...
    public static partial void LogRestoreBinEntry(this ILogger logger, string userId, string entryId);
}
